...
public class PerlinNoiseAnimatorState : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        for (int i = 0; i < parameters.Length; i++)
        {
            ...
            // A StateMachineBehaviour can be reused by controllers with different
            // parameter sets. Skip stale/misconfigured entries instead of making
            // Unity log "Parameter ... does not exist" every frame.
            if (string.IsNullOrWhiteSpace(param.parameterName) || !HasParameter(animator, param.parameterName, param.parameterType))
            {
                continue;
            }
    ...
    private static bool HasParameter(Animator animator, string parameterName, ParameterType parameterType)
    {
